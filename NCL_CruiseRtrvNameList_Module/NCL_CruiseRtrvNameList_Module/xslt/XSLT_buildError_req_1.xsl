...
<!-- @generated mapFile="xslt/XSLT_buildError_req_1.map" md5sum="dc32138ca16ce0c2e40b0ba7e9dbebd0" version="7.6.100" -->
<!--
*****************************************************************************
...
*   XSLT import(s):   	XSLT_buildError_req_1_custom.xsl
*
...
<xsl:stylesheet
  ...
  <!-- imports  -->
  <xsl:import href="XSLT_buildError_req_1_custom.xsl"/>
  ...
  <xsl:template match="/">
    <xsl:choose>
      <xsl:when test="msl:datamap">
        <msl:datamap>
          <xsl:element name="dataObject">
            ...
            <xsl:call-template name="map:XSLT_buildError_req_12">
      ...
      <xsl:otherwise>
        <xsl:apply-templates select="io2:smo" mode="map:XSLT_buildError_req_1"/>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>

  <!-- This rule represents an element mapping: "io2:smo" to "io2:smo".  -->
  <xsl:template match="io2:smo"  mode="map:XSLT_buildError_req_1">
    <io2:smo>
      <context>
        <correlation>
          <xsl:attribute name="xsi:type">
  ...
  <xsl:template name="map:XSLT_buildError_req_12">
    <xsl:param name="smo"/>
    <context>
      <correlation>
        <xsl:attribute name="xsi:type">
