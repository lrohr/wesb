...
<!-- @generated mapFile="xslt/XSLTransformation4_req_1.map" md5sum="c764dcb99468495cd1e537cf16cdf764" version="7.6.100" -->
<!--
*****************************************************************************
...
*   XSLT import(s):   	XSLTransformation4_req_1_custom.xsl, XSLTransformation4_req_1_dt_from.xsl, XSLTransformation4_req_1_get_Max.xsl, XSLTransformation4_req_1_date_to.xsl, XSLTransformation4_req_More.xsl
*
...
<xsl:stylesheet
  ...
  <xsl:import href="XSLTransformation4_req_1_dt_from.xsl"/>
  <xsl:import href="XSLTransformation4_req_1_get_Max.xsl"/>
  <xsl:import href="XSLTransformation4_req_1_date_to.xsl"/>
  <xsl:import href="XSLTransformation4_req_More.xsl"/>
      ...
      <xsl:element name="body">
        ...
        <xsl:element name="out2:Perform_NCL_CruiseRtrvNameListResponse">
          <xsl:element name="io5:NCL_CruiseRtrvNameListRS">
            ...
            <!-- a simple data mapping: "body/in:executeNclseaNcl_Wesb_Retrieve_Name_ListBGResponse/in:executeNclseaNcl_Wesb_Retrieve_Name_ListBGOutput/NclseaNcl_Wesb_Retrieve_Name_List/p_cursor"(NclseaNcl_Wesb_Retrieve_Name_ListP_Cursor) to "MoreDataEchoToken"(StringLength1to32) -->
            <xsl:if test="body/in:executeNclseaNcl_Wesb_Retrieve_Name_ListBGResponse/in:executeNclseaNcl_Wesb_Retrieve_Name_ListBGOutput/NclseaNcl_Wesb_Retrieve_Name_List/p_cursor">
              <xsl:attribute name="MoreDataEchoToken">
                <!-- variables for custom code -->
                <xsl:variable name="p_cursor" select="body/in:executeNclseaNcl_Wesb_Retrieve_Name_ListBGResponse/in:executeNclseaNcl_Wesb_Retrieve_Name_ListBGOutput/NclseaNcl_Wesb_Retrieve_Name_List/p_cursor"/>
                <xsl:variable name="res_id" select="body/in:executeNclseaNcl_Wesb_Retrieve_Name_ListBGResponse/in:executeNclseaNcl_Wesb_Retrieve_Name_ListBGOutput/NclseaNcl_Wesb_Retrieve_Name_List/p_cursor/res_id"/>
            ...
            <!-- a simple data mapping: "body/in:executeNclseaNcl_Wesb_Retrieve_Name_ListBGResponse/in:executeNclseaNcl_Wesb_Retrieve_Name_ListBGOutput/NclseaNcl_Wesb_Retrieve_Name_List/p_cursor"(NclseaNcl_Wesb_Retrieve_Name_ListP_Cursor) to "MoreIndicator"(boolean) -->
            <xsl:if test="body/in:executeNclseaNcl_Wesb_Retrieve_Name_ListBGResponse/in:executeNclseaNcl_Wesb_Retrieve_Name_ListBGOutput/NclseaNcl_Wesb_Retrieve_Name_List/p_cursor">
            ...
            <!-- a simple data mapping: "context/correlation/io5:NCL_CruiseRtrvNameListRQ/@SequenceNmbr"(nonNegativeInteger) to "SequenceNmbr"(nonNegativeInteger) -->
            <xsl:if test="context/correlation/io5:NCL_CruiseRtrvNameListRQ/@SequenceNmbr">
              <xsl:attribute name="SequenceNmbr">
                <xsl:value-of select="context/correlation/io5:NCL_CruiseRtrvNameListRQ/@SequenceNmbr"/>
              </xsl:attribute>
            </xsl:if>
            ...
            <xsl:element name="io5:GuestsInfo">
              <!-- a for-each transform: "p_cursor"(NclseaNcl_Wesb_Retrieve_Name_ListP_Cursor) to "io5:GuestInfo"(<Anonymous>) -->
              <xsl:apply-templates select="body/in:executeNclseaNcl_Wesb_Retrieve_Name_ListBGResponse/in:executeNclseaNcl_Wesb_Retrieve_Name_ListBGOutput/NclseaNcl_Wesb_Retrieve_Name_List/p_cursor" mode="localP_cursorToGuestInfo_2106623453"/>
            </xsl:element>
          </xsl:element>
        </xsl:element>
      </xsl:element>
    ...
    <xsl:element name="body">
      ...
      <xsl:element name="out2:Perform_NCL_CruiseRtrvNameListResponse">
        <xsl:element name="io5:NCL_CruiseRtrvNameListRS">
          ...
          <!-- a simple data mapping: "$smo/body/in:executeNclseaNcl_Wesb_Retrieve_Name_ListBGResponse/in:executeNclseaNcl_Wesb_Retrieve_Name_ListBGOutput/NclseaNcl_Wesb_Retrieve_Name_List/p_cursor"(NclseaNcl_Wesb_Retrieve_Name_ListP_Cursor) to "MoreDataEchoToken"(StringLength1to32) -->
          <xsl:if test="$smo/body/in:executeNclseaNcl_Wesb_Retrieve_Name_ListBGResponse/in:executeNclseaNcl_Wesb_Retrieve_Name_ListBGOutput/NclseaNcl_Wesb_Retrieve_Name_List/p_cursor">
            <xsl:attribute name="MoreDataEchoToken">
              <!-- variables for custom code -->
              <xsl:variable name="p_cursor" select="$smo/body/in:executeNclseaNcl_Wesb_Retrieve_Name_ListBGResponse/in:executeNclseaNcl_Wesb_Retrieve_Name_ListBGOutput/NclseaNcl_Wesb_Retrieve_Name_List/p_cursor"/>
              <xsl:variable name="res_id" select="$smo/body/in:executeNclseaNcl_Wesb_Retrieve_Name_ListBGResponse/in:executeNclseaNcl_Wesb_Retrieve_Name_ListBGOutput/NclseaNcl_Wesb_Retrieve_Name_List/p_cursor/res_id"/>
              <xsl:call-template name="P_cursorToMoreDataEchoToken">
                <xsl:with-param name="p_cursor" select="$p_cursor"/>
                <xsl:with-param name="res_id" select="$res_id"/>
              </xsl:call-template>
          ...
          <!-- a simple data mapping: "$smo/body/in:executeNclseaNcl_Wesb_Retrieve_Name_ListBGResponse/in:executeNclseaNcl_Wesb_Retrieve_Name_ListBGOutput/NclseaNcl_Wesb_Retrieve_Name_List/p_cursor"(NclseaNcl_Wesb_Retrieve_Name_ListP_Cursor) to "MoreIndicator"(boolean) -->
          <xsl:if test="$smo/body/in:executeNclseaNcl_Wesb_Retrieve_Name_ListBGResponse/in:executeNclseaNcl_Wesb_Retrieve_Name_ListBGOutput/NclseaNcl_Wesb_Retrieve_Name_List/p_cursor">
            <xsl:attribute name="MoreIndicator">
              <!-- variables for custom code -->
              <xsl:variable name="p_cursor" select="$smo/body/in:executeNclseaNcl_Wesb_Retrieve_Name_ListBGResponse/in:executeNclseaNcl_Wesb_Retrieve_Name_ListBGOutput/NclseaNcl_Wesb_Retrieve_Name_List/p_cursor"/>
          ...
          <!-- a simple data mapping: "$smo/context/correlation/io5:NCL_CruiseRtrvNameListRQ/@SequenceNmbr"(nonNegativeInteger) to "SequenceNmbr"(nonNegativeInteger) -->
          <xsl:if test="$smo/context/correlation/io5:NCL_CruiseRtrvNameListRQ/@SequenceNmbr">
            <xsl:attribute name="SequenceNmbr">
              <xsl:value-of select="$smo/context/correlation/io5:NCL_CruiseRtrvNameListRQ/@SequenceNmbr"/>
            </xsl:attribute>
          </xsl:if>
          ...
          <xsl:element name="io5:GuestsInfo">
            <!-- a for-each transform: "p_cursor"(NclseaNcl_Wesb_Retrieve_Name_ListP_Cursor) to "io5:GuestInfo"(<Anonymous>) -->
            <xsl:apply-templates select="$smo/body/in:executeNclseaNcl_Wesb_Retrieve_Name_ListBGResponse/in:executeNclseaNcl_Wesb_Retrieve_Name_ListBGOutput/NclseaNcl_Wesb_Retrieve_Name_List/p_cursor" mode="localP_cursorToGuestInfo_2106623453"/>
          </xsl:element>
        </xsl:element>
      </xsl:element>
    </xsl:element>
  ...
  <xsl:template match="p_cursor"  mode="localP_cursorToGuestInfo_2106623453">
    <io5:GuestInfo>
