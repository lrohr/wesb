...
<!-- @generated mapFile="xslt/xslt_handle_db_error.map" md5sum="0e9459ba43efe924216a598274204e56" version="7.6.100" -->
<!--
*****************************************************************************
*   This file has been generated by the IBM XML Mapping Editor.
*
*   Mapping file:		xslt_handle_db_error.map
*   Map declaration(s):	xslt_handle_db_error
*   Input file(s):		smo://smo/name%3Dwsdl-primary/correlationContext%3D%257Bhttp%253A%252F%252FNCL_CruiseRtrvNameList_Module%257DApp_Context/message%3D%257Bhttp%253A%252F%252FNCL_CruiseRtrvNameList_Module%252FDB_LOOKUP%257DexecuteNclseaNcl_Wesb_Get_Consumer_Nam_ListBGRequestMsg/xpath%3D%252F/smo.xsd
...
<xsl:stylesheet
    ...
    xmlns:map="http://NCL_CruiseRtrvNameList_Module/xslt/xslt_handle_db_error"
  ...
  <xsl:template match="/">
    <xsl:choose>
      <xsl:when test="msl:datamap">
        <msl:datamap>
          <xsl:element name="dataObject">
            ...
            <xsl:call-template name="map:xslt_handle_db_error2">
      ...
      <xsl:otherwise>
        <xsl:apply-templates select="io2:smo" mode="map:xslt_handle_db_error"/>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>

  <!-- This rule represents an element mapping: "io2:smo" to "io2:smo".  -->
  <xsl:template match="io2:smo"  mode="map:xslt_handle_db_error">
    <io2:smo>
      <context>
        <correlation>
          <xsl:attribute name="xsi:type">
  ...
  <xsl:template name="map:xslt_handle_db_error2">
    <xsl:param name="smo"/>
    <context>
      <correlation>
        <xsl:attribute name="xsi:type">
