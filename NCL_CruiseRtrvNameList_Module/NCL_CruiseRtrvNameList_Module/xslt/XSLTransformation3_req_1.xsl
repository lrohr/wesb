...
<!-- @generated mapFile="xslt/XSLTransformation3_req_1.map" md5sum="ead807798ebe441d84f970ae8d909bad" version="7.6.100" -->
<!--
*****************************************************************************
...
<xsl:stylesheet
    ...
    xmlns:map="http://NCL_CruiseRtrvNameList_Module/xslt/XSLTransformation3_req_1"
        ...
        <xsl:element name="out2:Perform_NCL_CruiseRtrvNameListResponse">
          <xsl:element name="io5:NCL_CruiseRtrvNameListRS">
            <xsl:element name="io5:GuestsInfo">
              ...
              <xsl:apply-templates select="body/in:executeNclseaNcl_Wesb_Retrieve_Name_ListBGResponse/in:executeNclseaNcl_Wesb_Retrieve_Name_ListBGOutput/NclseaNcl_Wesb_Retrieve_Name_List/p_cursor" mode="localP_cursorToGuestInfo_1721012146"/>
            </xsl:element>
          </xsl:element>
        </xsl:element>
      </xsl:element>
    ...
    <xsl:element name="body">
      ...
      <xsl:element name="out2:Perform_NCL_CruiseRtrvNameListResponse">
        <xsl:element name="io5:NCL_CruiseRtrvNameListRS">
          <xsl:element name="io5:GuestsInfo">
            <!-- a for-each transform: "p_cursor"(NclseaNcl_Wesb_Retrieve_Name_ListP_Cursor) to "io5:GuestInfo"(<Anonymous>) -->
            <xsl:apply-templates select="$smo/body/in:executeNclseaNcl_Wesb_Retrieve_Name_ListBGResponse/in:executeNclseaNcl_Wesb_Retrieve_Name_ListBGOutput/NclseaNcl_Wesb_Retrieve_Name_List/p_cursor" mode="localP_cursorToGuestInfo_1721012146"/>
          </xsl:element>
        </xsl:element>
      </xsl:element>
    </xsl:element>
  ...
  <xsl:template match="p_cursor"  mode="localP_cursorToGuestInfo_1721012146">
    <io5:GuestInfo>
      ...
      <io5:SailingInfo>
        <io5:SelectedSailing>
          ...
          <xsl:element name="io5:CruiseLine">
            ...
            <!-- a simple data mapping: "cruise_line_code"(string) to "VendorCode"(StringLength1to8) -->
