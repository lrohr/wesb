...
<!-- @generated mapFile="xslt/xslt_getnext_error_req_1.map" md5sum="d2f7bba31124d676abad80f0c761b707" version="7.6.100" -->
<!--
*****************************************************************************
*   This file has been generated by the IBM XML Mapping Editor.
*
*   Mapping file:		xslt_getnext_error_req_1.map
*   Map declaration(s):	xslt_getnext_error_req_1
...
<xsl:stylesheet
    ...
    xmlns:map="http://NCL_CruiseRtrvNameList_Module/xslt/xslt_getnext_error_req_1"
  ...
  <xsl:template match="/">
    <xsl:choose>
      <xsl:when test="msl:datamap">
        <msl:datamap>
          <xsl:element name="dataObject">
            ...
            <xsl:call-template name="map:xslt_getnext_error_req_12">
      ...
      <xsl:otherwise>
        <xsl:apply-templates select="io2:smo" mode="map:xslt_getnext_error_req_1"/>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>

  <!-- This rule represents an element mapping: "io2:smo" to "io2:smo".  -->
  <xsl:template match="io2:smo"  mode="map:xslt_getnext_error_req_1">
    <io2:smo>
      <context>
        <correlation>
          <xsl:attribute name="xsi:type">
  ...
  <xsl:template name="map:xslt_getnext_error_req_12">
    <xsl:param name="smo"/>
    <context>
      <correlation>
        <xsl:attribute name="xsi:type">
