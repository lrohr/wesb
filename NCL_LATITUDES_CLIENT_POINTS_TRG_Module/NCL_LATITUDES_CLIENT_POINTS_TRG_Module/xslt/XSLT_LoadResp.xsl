...
<!-- @generated mapFile="xslt/XSLT_LoadResp.map" md5sum="ccdc00da7adc4ede06656d9544fbc896" version="7.6.100" -->
<!--
*****************************************************************************
...
<xsl:stylesheet
    ...
    xmlns:map="http://NCL_LATITUDES_CLIENT_POINTS_TRG_Module/xslt/XSLT_LoadResp"
  ...
  <xsl:template match="io2:smo"  mode="map:XSLT_LoadResp">
    <io2:smo>
      <body>
        <xsl:attribute name="xsi:type">
          <xsl:value-of select="'out2:Perform_NCL_LATITUDES_CLIENT_POINTS_TRGResponseMsg'"/>
        </xsl:attribute>
        <out:Perform_NCL_LATITUDES_CLIENT_POINTS_TRGResponse>
          <!-- a structural mapping: "context/correlation/NCL_LATITUDES_CLIENT_POINTS_TRG_RESP"(<Anonymous>) to "NCL_LATITUDES_CLIENT_POINTS_TRG_RESP"(<Anonymous>) -->
          <xsl:copy-of select="context/correlation/NCL_LATITUDES_CLIENT_POINTS_TRG_RESP"/>
        </out:Perform_NCL_LATITUDES_CLIENT_POINTS_TRGResponse>
      </body>
    </io2:smo>
  </xsl:template>
  ...
  <xsl:template name="map:XSLT_LoadResp2">
    ...
    <body>
      ...
      <out:Perform_NCL_LATITUDES_CLIENT_POINTS_TRGResponse>
        <!-- a structural mapping: "$smo/context/correlation/NCL_LATITUDES_CLIENT_POINTS_TRG_RESP"(<Anonymous>) to "NCL_LATITUDES_CLIENT_POINTS_TRG_RESP"(<Anonymous>) -->
        <xsl:copy-of select="$smo/context/correlation/NCL_LATITUDES_CLIENT_POINTS_TRG_RESP"/>
      </out:Perform_NCL_LATITUDES_CLIENT_POINTS_TRGResponse>
    </body>
  </xsl:template>
