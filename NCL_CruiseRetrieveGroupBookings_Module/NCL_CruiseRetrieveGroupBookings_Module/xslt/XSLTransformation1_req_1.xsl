...
<!-- @generated mapFile="xslt/XSLTransformation1_req_1.map" md5sum="6ba902b16ae3300d57e85681b3f2d167" version="7.6.100" -->
<!--
*****************************************************************************
...
*   XSLT import(s):   	XSL_init_date_1.xsl, XSLTransformation1_req_1_custom.xsl, XSLT_sail_date_from.xsl, XSLTransformation1_req_1_status.xsl, XSLTransformation1_req_1_success.xsl
*
...
<xsl:stylesheet
  ...
  <!-- imports  -->
  <xsl:import href="XSL_init_date_1.xsl"/>
  <xsl:import href="XSLTransformation1_req_1_custom.xsl"/>
  <xsl:import href="XSLT_sail_date_from.xsl"/>
  <xsl:import href="XSLTransformation1_req_1_status.xsl"/>
  <xsl:import href="XSLTransformation1_req_1_success.xsl"/>
          ...
          <xsl:element name="io5:NCL_CruiseRetrieveGroupBookingsRS">
            ...
            <xsl:element name="io5:Warnings">
              <xsl:element name="io5:Warning">
                ...
                <xsl:variable name="p_errorcode" select="body/in:executeNclseaNcl_Wesb_Retrieve_Grp_BookingBGResponse/in:executeNclseaNcl_Wesb_Retrieve_Grp_BookingBGOutput/NclseaNcl_Wesb_Retrieve_Grp_Booking/p_errorcode"/>
                <xsl:if test="string_length($p_errorcode) &gt; &apos;0&apos;">
                ...
                <!-- variables for custom code -->
                <xsl:variable name="p_errormsg" select="body/in:executeNclseaNcl_Wesb_Retrieve_Grp_BookingBGResponse/in:executeNclseaNcl_Wesb_Retrieve_Grp_BookingBGOutput/NclseaNcl_Wesb_Retrieve_Grp_Booking/p_errormsg"/>
                <xsl:if test="string-length($p_errormsg) &gt; &apos;0&apos;">
            ...
            <xsl:element name="io5:GroupsInfo">
              ...
              <xsl:apply-templates select="body/in:executeNclseaNcl_Wesb_Retrieve_Grp_BookingBGResponse/in:executeNclseaNcl_Wesb_Retrieve_Grp_BookingBGOutput/NclseaNcl_Wesb_Retrieve_Grp_Booking/p_cursor" mode="localP_cursorToGroupInfo_82754784"/>
            </xsl:element>
          </xsl:element>
        </xsl:element>
      </xsl:element>
        ...
        <xsl:element name="io5:NCL_CruiseRetrieveGroupBookingsRS">
          ...
          <xsl:element name="io5:Warnings">
            <xsl:element name="io5:Warning">
              ...
              <!-- variables for custom code -->
              <xsl:variable name="p_errorcode" select="$smo/body/in:executeNclseaNcl_Wesb_Retrieve_Grp_BookingBGResponse/in:executeNclseaNcl_Wesb_Retrieve_Grp_BookingBGOutput/NclseaNcl_Wesb_Retrieve_Grp_Booking/p_errorcode"/>
              <xsl:if test="string_length($p_errorcode) &gt; &apos;0&apos;">
                <xsl:attribute name="Code">
              ...
              <!-- variables for custom code -->
              <xsl:variable name="p_errormsg" select="$smo/body/in:executeNclseaNcl_Wesb_Retrieve_Grp_BookingBGResponse/in:executeNclseaNcl_Wesb_Retrieve_Grp_BookingBGOutput/NclseaNcl_Wesb_Retrieve_Grp_Booking/p_errormsg"/>
              <xsl:if test="string-length($p_errormsg) &gt; &apos;0&apos;">
                <xsl:attribute name="ShortText">
          ...
          <xsl:element name="io5:GroupsInfo">
            <!-- a for-each transform: "p_cursor"(NclseaNcl_Wesb_Retrieve_Grp_BookingP_Cursor) to "io5:GroupInfo"(<Anonymous>) -->
            <xsl:apply-templates select="$smo/body/in:executeNclseaNcl_Wesb_Retrieve_Grp_BookingBGResponse/in:executeNclseaNcl_Wesb_Retrieve_Grp_BookingBGOutput/NclseaNcl_Wesb_Retrieve_Grp_Booking/p_cursor" mode="localP_cursorToGroupInfo_82754784"/>
          </xsl:element>
        </xsl:element>
      </xsl:element>
    </xsl:element>
  ...
  <xsl:template match="p_cursor"  mode="localP_cursorToGroupInfo_82754784">
    <io5:GroupInfo>
      ...
      <xsl:if test="allocationexist">
        <xsl:attribute name="AllocationExist">
          <xsl:value-of select="allocationexist"/>
        </xsl:attribute>
      </xsl:if>
      ...
      <xsl:if test="group_init_date">
        <xsl:attribute name="GroupInitDate">
          <!-- variables for custom code -->
          <xsl:variable name="group_init_date" select="group_init_date"/>
          <xsl:call-template name="Group_init_dateToGroupInitDate">
            <xsl:with-param name="group_init_date" select="$group_init_date"/>
          </xsl:call-template>
        </xsl:attribute>
      </xsl:if>
