...
public class _EJSRemoteStatelessRegisterTask_03dca8b1_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements Tie {
    
    private EJSRemoteStatelessRegisterTask_03dca8b1 target = null;
    private ORB orb = null;
    
    private static final String[] _type_ids = {
        "RMI:com.ibm.websphere.startupservice.AppStartUp:0000000000000000", 
    ...
    public void setTarget(Remote target) {
        this.target = (EJSRemoteStatelessRegisterTask_03dca8b1) target;
    }
            ...
            switch (method.length()) {
                case 4: 
                    if (method.equals("stop")) {
                        return stop(in, reply);
                    }
                case 5: 
                    if (method.equals("start")) {
                        return start(in, reply);
                    }
                case 6: 
    ...
    private OutputStream start(org.omg.CORBA_2_3.portable.InputStream in , ResponseHandler reply) throws Throwable {
    ...
    private OutputStream stop(org.omg.CORBA_2_3.portable.InputStream in , ResponseHandler reply) throws Throwable {
        target.stop();
        OutputStream out = reply.createReply();
        return out;
    }
