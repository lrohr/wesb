...
/**
 * @generated
 *  Flow: FuseBoxMediationSubFlow Interface: subflow Operation:  Type: request Custom Mediation: LogServiceInvocationFault
 */
public class Custom1341927859687 extends ESBMediationPrimitive {
			...
			{// Log Level: SEVERE
				...
				if (l.isLoggable(java.util.logging.Level.SEVERE)) {
					...
					serializer.writeDataObject(__result__4, __result__4
							...
							.getName(), stream);
					l.logp(java.util.logging.Level.SEVERE,
