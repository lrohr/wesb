    ...
    public boolean start() throws RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                ...
                try {
                    try {
                        OutputStream out = _request("start", true);
                        in = _invoke(out);
                        return in.read_boolean();
                    } catch (ApplicationException ex) {
                        in = ex.getInputStream();
                ...
                ServantObject so = _servant_preinvoke("start",com.ibm.websphere.startupservice.AppStartUp.class);
                if (so == null) {
                    continue;
                }
                try {
                    return ((com.ibm.websphere.startupservice.AppStartUp)so.servant).start();
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                    throw Util.wrapException(exCopy);
                } finally {
    ...
    public void stop() throws RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                ...
                try {
                    try {
                        OutputStream out = _request("stop", true);
                        _invoke(out);
                        return;
                    } catch (ApplicationException ex) {
                        in = ex.getInputStream();
                ...
                ServantObject so = _servant_preinvoke("stop",com.ibm.websphere.startupservice.AppStartUp.class);
                if (so == null) {
                    continue;
                }
                try {
                    ((com.ibm.websphere.startupservice.AppStartUp)so.servant).stop();
                    return;
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                    throw Util.wrapException(exCopy);
