...
public class _TaskHandlerHome_Stub extends Stub implements TaskHandlerHome {
    
    private static final String[] _type_ids = {
        "RMI:com.ibm.websphere.scheduler.TaskHandlerHome:0000000000000000", 
            ...
            if (!Util.isLocal(this)) {
                ...
                try {
                    try {
                        ...
                        return (EJBMetaData) (java.lang.Object) in.read_value(EJBMetaData.class);
                    } catch (ApplicationException ex) {
                        in = (InputStream) ex.getInputStream();
                        String id = in.read_string();
                        throw new UnexpectedException(id);
            ...
            if (!Util.isLocal(this)) {
                ...
                try {
                    try {
                        ...
                        in = (InputStream)_invoke(out);
                        return (TaskHandler) in.read_Object(TaskHandler.class);
                    } catch (ApplicationException ex) {
                        in = (InputStream) ex.getInputStream();
                        String id = in.read_string();
                ...
                ServantObject so = _servant_preinvoke("create",com.ibm.websphere.scheduler.TaskHandlerHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    TaskHandler result = ((com.ibm.websphere.scheduler.TaskHandlerHome)so.servant).create();
                    return (TaskHandler)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
