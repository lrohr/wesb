...
public class _EJSRemoteStatelessProdPostPendingCardTransaction_d76337a2_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements Tie {
    
    private EJSRemoteStatelessProdPostPendingCardTransaction_d76337a2 target = null;
    private ORB orb = null;
    
    private static final String[] _type_ids = {
        "RMI:com.ibm.websphere.scheduler.TaskHandler:0000000000000000", 
    ...
    public void setTarget(Remote target) {
        this.target = (EJSRemoteStatelessProdPostPendingCardTransaction_d76337a2) target;
    }
    ...
    private OutputStream process(org.omg.CORBA_2_3.portable.InputStream in , ResponseHandler reply) throws Throwable {
        TaskStatus arg0 = (TaskStatus) (java.lang.Object) in.read_value(TaskStatus.class);
        target.process(arg0);
        OutputStream out = reply.createReply();
        return out;
    }
