...
public class _TaskHandler_Stub extends Stub implements TaskHandler {
            ...
            if (!Util.isLocal(this)) {
                ...
                try {
                    try {
                        ...
                        out.write_value((Serializable)arg0,TaskStatus.class);
                        _invoke(out);
                        return;
                    } catch (ApplicationException ex) {
                        in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                ...
                ServantObject so = _servant_preinvoke("process",com.ibm.websphere.scheduler.TaskHandler.class);
                if (so == null) {
                    continue;
                }
                try {
                    TaskStatus arg0Copy = (TaskStatus) Util.copyObject(arg0,_orb());
                    ((com.ibm.websphere.scheduler.TaskHandler)so.servant).process(arg0Copy);
                    return;
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                    throw Util.wrapException(exCopy);
