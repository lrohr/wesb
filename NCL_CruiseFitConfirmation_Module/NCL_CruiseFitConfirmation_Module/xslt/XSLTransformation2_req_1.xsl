...
<!-- @generated mapFile="xslt/XSLTransformation2_req_1.map" md5sum="350d67709da47cc974cdff2f6845b18a" version="7.6.100" -->
<!--
*****************************************************************************
    ...
    <io2:smo>
      <context>
        <correlation>
          ...
          <!-- a structural mapping: "context/correlation/io5:NCL_CruiseFitConfirmationRQ"(<Anonymous>) to "io5:NCL_CruiseFitConfirmationRQ"(<Anonymous>) -->
          <xsl:if test="context/correlation/io5:NCL_CruiseFitConfirmationRQ">
            <xsl:copy-of select="context/correlation/io5:NCL_CruiseFitConfirmationRQ"/>
          </xsl:if>
      ...
      <xsl:element name="body">
        <xsl:attribute name="xsi:type">
          <xsl:value-of select="'out:Perform_NCL_CruiseFitConfirmationResponseMsg'"/>
        </xsl:attribute>
        <xsl:element name="out2:Perform_NCL_CruiseFitConfirmationResponse">
          <xsl:element name="io5:NCL_CruiseFitConfirmationRS">
            <!-- a simple data mapping: "context/correlation/io5:NCL_CruiseFitConfirmationRQ/@TransactionIdentifier"(StringLength1to32) to "TransactionIdentifier"(StringLength1to32) -->
            <xsl:if test="context/correlation/io5:NCL_CruiseFitConfirmationRQ/@TransactionIdentifier">
              <xsl:attribute name="TransactionIdentifier">
                <xsl:value-of select="context/correlation/io5:NCL_CruiseFitConfirmationRQ/@TransactionIdentifier"/>
              </xsl:attribute>
            </xsl:if>
  ...
  <xsl:template name="map:XSLTransformation2_req_12">
    ...
    <context>
      <correlation>
        ...
        <!-- a structural mapping: "$smo/context/correlation/io5:NCL_CruiseFitConfirmationRQ"(<Anonymous>) to "io5:NCL_CruiseFitConfirmationRQ"(<Anonymous>) -->
        <xsl:if test="$smo/context/correlation/io5:NCL_CruiseFitConfirmationRQ">
          <xsl:copy-of select="$smo/context/correlation/io5:NCL_CruiseFitConfirmationRQ"/>
        </xsl:if>
    ...
    <xsl:element name="body">
      ...
      <xsl:element name="out2:Perform_NCL_CruiseFitConfirmationResponse">
        <xsl:element name="io5:NCL_CruiseFitConfirmationRS">
          <!-- a simple data mapping: "$smo/context/correlation/io5:NCL_CruiseFitConfirmationRQ/@TransactionIdentifier"(StringLength1to32) to "TransactionIdentifier"(StringLength1to32) -->
          <xsl:if test="$smo/context/correlation/io5:NCL_CruiseFitConfirmationRQ/@TransactionIdentifier">
            <xsl:attribute name="TransactionIdentifier">
              <xsl:value-of select="$smo/context/correlation/io5:NCL_CruiseFitConfirmationRQ/@TransactionIdentifier"/>
            </xsl:attribute>
          </xsl:if>
          <!-- a structural mapping with no associated source:  to "io5:Success"(SuccessType) -->
          <xsl:element name="io5:Success">
