...
/**
 * @generated
 *  Flow: NCL_CruiseCreateClient_Module Interface: NCL_CruiseCreateClient_Interface Operation: Perform_NCL_CruiseCreateClient Type: request Custom Mediation: CustomMediation1
 */
public class Custom1257372190993 extends ESBMediationPrimitive {
	...
	public void doMediate(InputTerminal inputTerminal, ServiceMessageObject smo)
		...
		commonj.sdo.DataObject __result__1 = __smo.getDataObject("body")
				.getDataObject("Perform_NCL_CruiseCreateClientResponse")
				.getDataObject("NCL_CruiseCreateClientRS");
