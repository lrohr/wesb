...
*
*   Mapping file:		xslt_swResObj_Timeout_req_1.map
*   Map declaration(s):	xslt_swResObj_Timeout_req_1
*   Input file(s):		smo://smo/name%3Dwsdl-primary/correlationContext%3D%257Bhttp%253A%252F%252FNCL_CruiseCreateClient_Module%257DApp_context/message%3D%257Bhttp%253A%252F%252FNCL_WESB_Shared_Library%252FEncrypt_Decrypt_Interface%257DprocessEncryptDecryptRequest/xpath%3D%252F/smo.xsd
...
<xsl:stylesheet
     ...
     xmlns:map="http://NCL_CruiseCreateClient_Module/xslt/xslt_swResObj_Timeout_req_1"
