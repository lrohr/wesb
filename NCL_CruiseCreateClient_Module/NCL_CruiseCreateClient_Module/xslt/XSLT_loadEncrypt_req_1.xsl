...
<!-- @generated mapFile="xslt/XSLT_loadEncrypt_req_1.map" md5sum="3a33f1130c8ce1972deaddb7c11ae0ef" version="7.6.100" -->
<!--
*****************************************************************************
*   This file has been generated by the IBM XML Mapping Editor.
*
*   Mapping file:		XSLT_loadEncrypt_req_1.map
*   Map declaration(s):	XSLT_loadEncrypt_req_1
...
*   Output file(s):		smo://smo/name%3Dwsdl-primary/correlationContext%3D%257Bhttp%253A%252F%252FNCL_CruiseCreateClient_Module%257DApp_context/message%3D%257Bhttp%253A%252F%252FNCL_WESB_Shared_Library%252FEncrypt_Decrypt_Interface%257DprocessEncryptDecryptRequest/xpath%3D%252F/smo.xsd
*
...
<xsl:stylesheet
    ...
    xmlns:map="http://NCL_CruiseCreateClient_Module/xslt/XSLT_loadEncrypt_req_1"
  ...
  <xsl:template match="/">
    <xsl:choose>
      <xsl:when test="msl:datamap">
        <msl:datamap>
          <xsl:element name="dataObject">
            ...
            <xsl:call-template name="map:XSLT_loadEncrypt_req_12">
      ...
      <xsl:otherwise>
        <xsl:apply-templates select="io2:smo" mode="map:XSLT_loadEncrypt_req_1"/>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>

  <!-- This rule represents an element mapping: "io2:smo" to "io2:smo".  -->
  <xsl:template match="io2:smo"  mode="map:XSLT_loadEncrypt_req_1">
    <io2:smo>
      <context>
        <correlation>
          <xsl:attribute name="xsi:type">
          ...
          <!-- a simple data mapping: "context/correlation/io6:NCL_CruiseCreateClientRQ/io6:UserLogin/@Password"(StringLength1to64) to "inputPasswordLength"(int) -->
          <xsl:if test="context/correlation/io6:NCL_CruiseCreateClientRQ/io6:UserLogin/@Password">
            <xsl:element name="inputPasswordLength">
              <!-- variables for custom code -->
              <xsl:variable name="Password" select="context/correlation/io6:NCL_CruiseCreateClientRQ/io6:UserLogin/@Password"/>
      ...
      <xsl:element name="body">
        ...
        <xsl:element name="out2:processEncryptDecryptRequest">
          <xsl:element name="Encrypt_Decrypt">
            ...
            <!-- a simple data mapping: "context/correlation/io6:NCL_CruiseCreateClientRQ/io6:UserLogin/@Password"(StringLength1to64) to "DecryptString"(string) -->
            <xsl:if test="context/correlation/io6:NCL_CruiseCreateClientRQ/io6:UserLogin/@Password">
              <xsl:element name="DecryptString">
                <xsl:value-of select="context/correlation/io6:NCL_CruiseCreateClientRQ/io6:UserLogin/@Password"/>
              </xsl:element>
            </xsl:if>
          </xsl:element>
        </xsl:element>
  ...
  <xsl:template name="map:XSLT_loadEncrypt_req_12">
    <xsl:param name="smo"/>
    <context>
      <correlation>
        <xsl:attribute name="xsi:type">
        ...
        <!-- a simple data mapping: "$smo/context/correlation/io6:NCL_CruiseCreateClientRQ/io6:UserLogin/@Password"(StringLength1to64) to "inputPasswordLength"(int) -->
        <xsl:if test="$smo/context/correlation/io6:NCL_CruiseCreateClientRQ/io6:UserLogin/@Password">
          <xsl:element name="inputPasswordLength">
            <!-- variables for custom code -->
            <xsl:variable name="Password" select="$smo/context/correlation/io6:NCL_CruiseCreateClientRQ/io6:UserLogin/@Password"/>
            <xsl:value-of select="string-length($Password)"/>
          </xsl:element>
        </xsl:if>
      </correlation>
    ...
    <xsl:element name="body">
      ...
      <xsl:element name="out2:processEncryptDecryptRequest">
        <xsl:element name="Encrypt_Decrypt">
          ...
          <!-- a simple data mapping: "$smo/context/correlation/io6:NCL_CruiseCreateClientRQ/io6:UserLogin/@Password"(StringLength1to64) to "DecryptString"(string) -->
          <xsl:if test="$smo/context/correlation/io6:NCL_CruiseCreateClientRQ/io6:UserLogin/@Password">
            <xsl:element name="DecryptString">
              <xsl:value-of select="$smo/context/correlation/io6:NCL_CruiseCreateClientRQ/io6:UserLogin/@Password"/>
            </xsl:element>
          </xsl:if>
        </xsl:element>
      </xsl:element>
