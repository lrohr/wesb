...
<!-- @generated mapFile="xslt/XSLTransformation3_req_1.map" md5sum="bd4adc31b328ef78ae5a582f18761d0f" version="7.6.100" -->
<!--
*****************************************************************************
...
<xsl:stylesheet
    ...
    xmlns:map="http://Generic_Service/xslt/XSLTransformation3_req_1"
        ...
        <out:sendSimpleAlertEmail>
          <out:sendSimpleAlertEmailInput>
            ...
            <xsl:element name="Subject">
              <xsl:text>Error (Error Handler)</xsl:text>
            </xsl:element>
