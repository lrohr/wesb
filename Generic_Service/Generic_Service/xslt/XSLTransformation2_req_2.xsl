...
<!-- @generated mapFile="xslt/XSLTransformation2_req_2.map" md5sum="17b159fd4be3944865bb5b5415916d24" version="7.6.100" -->
<!--
*****************************************************************************
...
<xsl:stylesheet
    ...
    xmlns:map="http://Generic_Service/xslt/XSLTransformation2_req_2"
        ...
        <xsl:element name="out:sendSimpleAlertEmail">
          <xsl:element name="out:sendSimpleAlertEmailInput">
            ...
            <xsl:element name="Subject">
              <xsl:text>Error From Mediation</xsl:text>
            </xsl:element>
