...
<!-- @generated mapFile="xslt/XSLT_RouteDefault_req_1.map" md5sum="02ec246a5e33b65d6064a2dec26a6ae3" version="7.6.100" -->
<!--
*****************************************************************************
*   This file has been generated by the IBM XML Mapping Editor.
*
*   Mapping file:		XSLT_RouteDefault_req_1.map
*   Map declaration(s):	XSLT_RouteDefault_req_1
...
<xsl:stylesheet
    ...
    xmlns:map="http://Generic_Service/xslt/XSLT_RouteDefault_req_1"
  ...
  <xsl:template match="/">
    <xsl:choose>
      <xsl:when test="msl:datamap">
        <msl:datamap>
          <xsl:element name="dataObject">
            ...
            <xsl:call-template name="map:XSLT_RouteDefault_req_12">
      ...
      <xsl:otherwise>
        <xsl:apply-templates select="io2:smo" mode="map:XSLT_RouteDefault_req_1"/>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>

  <!-- This rule represents an element mapping: "io2:smo" to "io2:smo".  -->
  <xsl:template match="io2:smo"  mode="map:XSLT_RouteDefault_req_1">
    <io2:smo>
      <context>
        <correlation>
          <xsl:attribute name="xsi:type">
        ...
        <xsl:element name="out:sendSimpleAlertEmail">
          <xsl:element name="out:sendSimpleAlertEmailInput">
            ...
            <xsl:element name="Subject">
              <xsl:text>Error RouteDefault</xsl:text>
            </xsl:element>
            <!-- a simple data mapping: "context/correlation/request"(string) to "mailContent"(string) -->
            <xsl:if test="context/correlation/request">
  ...
  <xsl:template name="map:XSLT_RouteDefault_req_12">
    <xsl:param name="smo"/>
    <context>
      <correlation>
        <xsl:attribute name="xsi:type">
    ...
    <xsl:element name="body">
      ...
      <xsl:element name="out:sendSimpleAlertEmail">
        <xsl:element name="out:sendSimpleAlertEmailInput">
          ...
          <!-- a simple data mapping: "$smo/context/correlation/request"(string) to "mailContent"(string) -->
          <xsl:if test="$smo/context/correlation/request">
            <xsl:element name="mailContent">
              <xsl:value-of select="$smo/context/correlation/request"/>
            </xsl:element>
