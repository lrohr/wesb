...
<!-- @generated mapFile="xslt/xsltSavePagingAgent.map" md5sum="98c0cf8cb1d74c20f1f95aa680bef584" version="7.6.100" -->
<!--
*****************************************************************************
...
*   XSLT import(s):   	xsltSavePagingAgent_custom_2.xsl
*
...
<xsl:stylesheet
  ...
  <!-- imports  -->
  <xsl:import href="xsltSavePagingAgent_custom_2.xsl"/>
  ...
  <xsl:template match="/">
    <xsl:choose>
      <xsl:when test="msl:datamap">
        <msl:datamap>
          <xsl:element name="dataObject">
            ...
            <xsl:call-template name="map:xsltSavePagingAgent2">
      ...
      <xsl:otherwise>
        <xsl:apply-templates select="io3:smo" mode="map:xsltSavePagingAgent"/>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>

  <!-- This rule represents an element mapping: "io3:smo" to "io3:smo".  -->
  <xsl:template match="io3:smo"  mode="map:xsltSavePagingAgent">
    <io3:smo>
      <context>
        <correlation>
          <xsl:attribute name="xsi:type">
          ...
          <xsl:element name="agent_work_getAgent">
            <xsl:element name="spGetAgentInfo">
              <!-- a simple data mapping: "body/in8:executeNclseaNcl_Wesb_Get_Agent_With_PagingResponse/in8:executeNclseaNcl_Wesb_Get_Agent_With_PagingOutput/p_last_agent_id"(string) to "P_TOTALCOUNT"(string) -->
              <xsl:if test="body/in8:executeNclseaNcl_Wesb_Get_Agent_With_PagingResponse/in8:executeNclseaNcl_Wesb_Get_Agent_With_PagingOutput/p_last_agent_id">
                <xsl:element name="P_TOTALCOUNT">
                  <!-- variables for custom code -->
                  <xsl:variable name="p_last_agent_id8" select="body/in8:executeNclseaNcl_Wesb_Get_Agent_With_PagingResponse/in8:executeNclseaNcl_Wesb_Get_Agent_With_PagingOutput/p_last_agent_id"/>
                  <xsl:call-template name="P_last_agent_idToP_TOTALCOUNT">
                    <xsl:with-param name="p_last_agent_id8" select="$p_last_agent_id8"/>
                  </xsl:call-template>
                </xsl:element>
              </xsl:if>
              <!-- a for-each transform: "p_cursor"(NclseaNcl_Wesb_Get_Agent_With_PagingP_Cursor) to "P_CURSOR"(<Anonymous>) -->
              <xsl:apply-templates select="body/in8:executeNclseaNcl_Wesb_Get_Agent_With_PagingResponse/in8:executeNclseaNcl_Wesb_Get_Agent_With_PagingOutput/p_cursor" mode="localP_cursorToP_CURSOR_952275753"/>
            </xsl:element>
          </xsl:element>
        </correlation>
      </context>
  ...
  <xsl:template name="map:xsltSavePagingAgent2">
    <xsl:param name="smo"/>
    <context>
      <correlation>
        <xsl:attribute name="xsi:type">
        ...
        <xsl:element name="agent_work_getAgent">
          <xsl:element name="spGetAgentInfo">
            <!-- a simple data mapping: "$smo/body/in8:executeNclseaNcl_Wesb_Get_Agent_With_PagingResponse/in8:executeNclseaNcl_Wesb_Get_Agent_With_PagingOutput/p_last_agent_id"(string) to "P_TOTALCOUNT"(string) -->
            <xsl:if test="$smo/body/in8:executeNclseaNcl_Wesb_Get_Agent_With_PagingResponse/in8:executeNclseaNcl_Wesb_Get_Agent_With_PagingOutput/p_last_agent_id">
              <xsl:element name="P_TOTALCOUNT">
                <!-- variables for custom code -->
                <xsl:variable name="p_last_agent_id8" select="$smo/body/in8:executeNclseaNcl_Wesb_Get_Agent_With_PagingResponse/in8:executeNclseaNcl_Wesb_Get_Agent_With_PagingOutput/p_last_agent_id"/>
                <xsl:call-template name="P_last_agent_idToP_TOTALCOUNT">
                  <xsl:with-param name="p_last_agent_id8" select="$p_last_agent_id8"/>
                </xsl:call-template>
              </xsl:element>
            ...
            <!-- a for-each transform: "p_cursor"(NclseaNcl_Wesb_Get_Agent_With_PagingP_Cursor) to "P_CURSOR"(<Anonymous>) -->
            <xsl:apply-templates select="$smo/body/in8:executeNclseaNcl_Wesb_Get_Agent_With_PagingResponse/in8:executeNclseaNcl_Wesb_Get_Agent_With_PagingOutput/p_cursor" mode="localP_cursorToP_CURSOR_952275753"/>
          </xsl:element>
        </xsl:element>
      </correlation>
    </context>
  ...
  <xsl:template match="p_cursor"  mode="localP_cursorToP_CURSOR_952275753">
    <P_CURSOR>
      ...
      <!-- a simple data mapping: "web_password"(string) to "WEB_PASSWORD"(string) -->
