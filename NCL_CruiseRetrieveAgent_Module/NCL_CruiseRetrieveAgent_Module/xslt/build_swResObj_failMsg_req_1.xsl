...
<!-- @generated mapFile="xslt/build_swResObj_failMsg_req_1.map" md5sum="f1321f598682d1c3e04e378e19e7f80c" version="7.6.100" -->
<!--
*****************************************************************************
...
*   XSLT import(s):   	build_swResObj_failMsg_req_1_custom.xsl
*
...
<xsl:stylesheet
  ...
  <!-- imports  -->
  <xsl:import href="build_swResObj_failMsg_req_1_custom.xsl"/>
  ...
  <xsl:template match="/">
    <xsl:choose>
      <xsl:when test="msl:datamap">
        <msl:datamap>
          <xsl:element name="dataObject">
            ...
            <xsl:call-template name="map:build_swResObj_failMsg_req_12">
      ...
      <xsl:otherwise>
        <xsl:apply-templates select="io3:smo" mode="map:build_swResObj_failMsg_req_1"/>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>

  <!-- This rule represents an element mapping: "io3:smo" to "io3:smo".  -->
  <xsl:template match="io3:smo"  mode="map:build_swResObj_failMsg_req_1">
    <io3:smo>
      <context>
        <correlation>
          <xsl:attribute name="xsi:type">
            ...
            <xsl:element name="io6:Warnings">
              <xsl:element name="io6:Warning">
                ...
                <xsl:attribute name="ShortText">
                  <xsl:value-of select="'Seaware is not available.    Please try later'"/>
                </xsl:attribute>
              </xsl:element>
            </xsl:element>
          </xsl:element>
  ...
  <xsl:template name="map:build_swResObj_failMsg_req_12">
    <xsl:param name="smo"/>
    <context>
      <correlation>
        <xsl:attribute name="xsi:type">
