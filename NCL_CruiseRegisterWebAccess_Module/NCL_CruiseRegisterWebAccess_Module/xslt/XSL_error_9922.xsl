...
<!-- @generated mapFile="xslt/XSL_error_9922.map" md5sum="91299e209531d95815195bf4e39bc9af" version="7.6.100" -->
<!--
*****************************************************************************
...
*   XSLT import(s):   	XSL_error_9922_success.xsl
*
...
<xsl:stylesheet
    ...
    xmlns:map="http://NCL_CruiseRegisterWebAccess_Module/xslt/XSL_error_9922"
    xmlns:msl="http://www.ibm.com/xmlmap"
    exclude-result-prefixes="in in2 in3 in4 in5 in6 in7 str set math fn regexp dyn dp exsl date map xalan msl"
    version="1.0">

  <!-- imports  -->
  <xsl:import href="XSL_error_9922_success.xsl"/>
  ...
  <xsl:template match="/">
    <xsl:choose>
      <xsl:when test="msl:datamap">
        <msl:datamap>
          <xsl:element name="dataObject">
            ...
            <xsl:call-template name="map:XSL_error_99222">
      ...
      <xsl:otherwise>
        <xsl:apply-templates select="io2:smo" mode="map:XSL_error_9922"/>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>

  <!-- This rule represents an element mapping: "io2:smo" to "io2:smo".  -->
  <xsl:template match="io2:smo"  mode="map:XSL_error_9922">
    <io2:smo>
      <context>
        <correlation>
          <xsl:attribute name="xsi:type">
  ...
  <xsl:template name="map:XSL_error_99222">
    <xsl:param name="smo"/>
    <context>
      <correlation>
        <xsl:attribute name="xsi:type">
