...
*
*   Mapping file:		Error_9923_req_1.map
*   Map declaration(s):	Error_9923_req_1
*   Input file(s):		smo://smo/name%3Dwsdl-primary/correlationContext%3D%257Bhttp%253A%252F%252FNCL_CruiseRegisterWebAccess_Module%257Dapp_context/message%3D%257Bhttp%253A%252F%252FNCL_CruiseRegisterWebAccess_Module%252FDB_LOOKUP%257DexecuteNclseaNcl_Wesb_Register_Agcy_LookupBGRequestMsg/xpath%3D%252F/smo.xsd
...
<xsl:stylesheet
     ...
     xmlns:map="http://NCL_CruiseRegisterWebAccess_Module/xslt/Error_9923_req_1"
     exclude-result-prefixes="in in2 in3 in4 in5 in6 in7 str set math fn regexp dyn dp exsl date map xalan"
     version="1.0">
