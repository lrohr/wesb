...
/**
 * @generated
 *  Flow: NCL_CruiseRegisterWebAccess_Module Interface: NCL_CruiseRegisterWebAccess_Interface Operation: Perform_NCL_CruiseRegisterWebAccess Type: request Custom Mediation: CustomMediation1
 */
public class Custom1259690759178 extends ESBMediationPrimitive {
	...
	public void doMediate(InputTerminal inputTerminal, ServiceMessageObject smo)
		...
		commonj.sdo.DataObject __result__4 = __smo.getDataObject("body")
				.getDataObject("Perform_NCL_CruiseRegisterWebAccessResponse")
				.getDataObject("NCL_CruiseRegisterWebAccessRS");
