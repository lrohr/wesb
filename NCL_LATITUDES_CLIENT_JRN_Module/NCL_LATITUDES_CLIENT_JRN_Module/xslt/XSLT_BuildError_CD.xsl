...
<xsl:stylesheet
  ...
  <!-- The rule represents a custom mapping: "in2:executeNclseaNcl_Lat_Get_JrnOutput" to "ERROR_CODE". -->
  <xsl:template name="ExecuteNclseaNcl_Lat_Get_JrnOutputToERROR_CODE">
