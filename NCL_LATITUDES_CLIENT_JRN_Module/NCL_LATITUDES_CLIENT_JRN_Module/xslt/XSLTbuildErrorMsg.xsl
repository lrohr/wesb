...
<xsl:stylesheet
  ...
  <!-- The rule represents a custom mapping: "p_cursor" to "ERROR_MSG". -->
  <xsl:template name="P_cursorToERROR_MSG">
    ...
    <!-- ADD CUSTOM CODE HERE. -->
          ...
          <xsl:choose>
            ...
            <xsl:otherwise>
              <xsl:value-of select="'No data for requested client'"></xsl:value-of>
            </xsl:otherwise>
          </xsl:choose>
