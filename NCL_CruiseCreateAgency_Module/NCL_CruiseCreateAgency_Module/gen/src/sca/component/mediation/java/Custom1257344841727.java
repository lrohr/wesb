...
/**
 * @generated
 *  Flow: NCL_CruiseCreateAgency_Module Interface: NCL_CruiseCreateAgency_Interface Operation: Perform_NCL_CruiseCreateAgency Type: request Custom Mediation: removeEmptyWarnings2
 */
public class Custom1257344841727 extends ESBMediationPrimitive {
	...
	public void doMediate(InputTerminal inputTerminal, ServiceMessageObject smo)
		...
		commonj.sdo.DataObject __result__3 = __smo.getDataObject("body")
				.getDataObject("Perform_NCL_CruiseCreateAgencyResponse")
				.getDataObject("NCL_CruiseCreateAgencyRS");
		...
		//  </executableElements>
		//  <executableElements xsi:type="com.ibm.wbit.activity:Expression" value="smo.body.Perform_NCL_CruiseCreateAgencyResponse.NCL_CruiseCreateAgencyRS" field="true">
		//    <dataOutputs target="//@executableElements.3/@parameters.0"/>
		//    <type xsi:type="com.ibm.wbit.activity:XSDElementType" name="NCL_CruiseCreateAgencyRS;/NCL_CruiseCreateAgencyRS" namespace="http://nclapi/schemas"/>
		//  </executableElements>
