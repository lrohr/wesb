...
<!-- @generated mapFile="xslt/loadUpdate_req_1.map" md5sum="9839406b7cf383934e9be1573b21a2db" version="7.5.100" -->
<!--
*****************************************************************************
*   This file has been generated by the IBM XML Mapping Editor.
*
*   Mapping file:		loadUpdate_req_1.map
*   Map declaration(s):	loadUpdate_req_1
...
*   Output file(s):		smo://smo/name%3Dwsdl-primary/correlationContext%3D%257Bhttp%253A%252F%252FTP_Logger%257DappContext/message%3D%257Bhttp%253A%252F%252FTP_Logger%252FJDBCOutboundInterface%257DexecuteNclseaNcl_Esb_Update_Tp_LogBGRequestMsg/xpath%3D%252F/smo.xsd
*
...
<xsl:stylesheet
    ...
    xmlns:map="http://TP_Logger/xslt/loadUpdate_req_1"
  ...
  <xsl:template match="/">
    <xsl:choose>
      <xsl:when test="msl:datamap">
        <msl:datamap>
          <xsl:element name="dataObject">
            ...
            <xsl:call-template name="map:loadUpdate_req_12">
      ...
      <xsl:otherwise>
        <xsl:apply-templates select="io3:smo" mode="map:loadUpdate_req_1"/>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>

  <!-- This rule represents an element mapping: "io3:smo" to "io3:smo".  -->
  <xsl:template match="io3:smo"  mode="map:loadUpdate_req_1">
    <io3:smo>
      <body>
        <xsl:attribute name="xsi:type">
        ...
        <out:executeNclseaNcl_Esb_Update_Tp_LogBG>
          <out:executeNclseaNcl_Esb_Update_Tp_LogBGInput>
            <NclseaNcl_Esb_Update_Tp_Log>
              <!-- a simple data mapping: "context/correlation/RESPONSE_TS"(Date_Format) to "response_ts"(string) -->
              ...
              <!-- a simple data mapping: "context/correlation/RESPONSE_TYPE_CD"(string) to "response_type"(string) -->
              ...
              <!-- a simple data mapping: "context/correlation/XML"(string) to "response_msg"(string) -->
  ...
  <xsl:template name="map:loadUpdate_req_12">
    <xsl:param name="smo"/>
    <body>
      <xsl:attribute name="xsi:type">
        <xsl:value-of select="'out3:executeNclseaNcl_Esb_Update_Tp_LogBGRequestMsg'"/>
      ...
      <out:executeNclseaNcl_Esb_Update_Tp_LogBG>
        <out:executeNclseaNcl_Esb_Update_Tp_LogBGInput>
          <NclseaNcl_Esb_Update_Tp_Log>
            <!-- a simple data mapping: "$smo/context/correlation/RESPONSE_TS"(Date_Format) to "response_ts"(string) -->
            <xsl:if test="$smo/context/correlation/RESPONSE_TS">
              <xsl:element name="response_ts">
                <xsl:value-of select="$smo/context/correlation/RESPONSE_TS"/>
              </xsl:element>
            </xsl:if>
            <!-- a simple data mapping: "$smo/context/correlation/RESPONSE_TYPE_CD"(string) to "response_type"(string) -->
            <xsl:if test="$smo/context/correlation/RESPONSE_TYPE_CD">
              <xsl:element name="response_type">
                <xsl:value-of select="$smo/context/correlation/RESPONSE_TYPE_CD"/>
              </xsl:element>
            </xsl:if>
            <!-- a simple data mapping: "$smo/context/correlation/XML"(string) to "response_msg"(string) -->
