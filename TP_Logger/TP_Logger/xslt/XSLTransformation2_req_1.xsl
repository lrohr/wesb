...
<!-- @generated mapFile="xslt/XSLTransformation2_req_1.map" md5sum="802cf6779168d6f20228d023212c923a" version="7.6.100" -->
<!--
*****************************************************************************
...
<xsl:stylesheet
    ...
    xmlns:map="http://TP_Logger/xslt/XSLTransformation2_req_1"
        ...
        <out2:sendSimpleAlertEmail>
          <out2:sendSimpleAlertEmailInput>
            ...
            <xsl:element name="Subject">
              <xsl:text>WESB Error Updating TP log</xsl:text>
            </xsl:element>
            <!-- a simple data mapping: "body/in:executeNclseaNcl_Esb_Update_Tp_LogBG/in:executeNclseaNcl_Esb_Update_Tp_LogBGInput/NclseaNcl_Esb_Update_Tp_Log/record_id"(string) to "mailContent"(string) -->
            <xsl:if test="body/in:executeNclseaNcl_Esb_Update_Tp_LogBG/in:executeNclseaNcl_Esb_Update_Tp_LogBGInput/NclseaNcl_Esb_Update_Tp_Log/record_id">
              <xsl:element name="mailContent">
                <!-- variables for custom code -->
                <xsl:variable name="record_id" select="body/in:executeNclseaNcl_Esb_Update_Tp_LogBG/in:executeNclseaNcl_Esb_Update_Tp_LogBGInput/NclseaNcl_Esb_Update_Tp_Log/record_id"/>
                <xsl:variable name="response_msg" select="body/in:executeNclseaNcl_Esb_Update_Tp_LogBG/in:executeNclseaNcl_Esb_Update_Tp_LogBGInput/NclseaNcl_Esb_Update_Tp_Log/response_msg"/>
                <xsl:variable name="failureString" select="context/failInfo/failureString"/>
                <xsl:call-template name="Record_idToMailContent">
                  <xsl:with-param name="record_id" select="$record_id"/>
                  <xsl:with-param name="failureString" select="$failureString"/>
                  <xsl:with-param name="response_msg" select="$response_msg"/>
                </xsl:call-template>
              </xsl:element>
            </xsl:if>
          </out2:sendSimpleAlertEmailInput>
    ...
    <body>
      ...
      <out2:sendSimpleAlertEmail>
        <out2:sendSimpleAlertEmailInput>
          ...
          <!-- a simple data mapping: "$smo/body/in:executeNclseaNcl_Esb_Update_Tp_LogBG/in:executeNclseaNcl_Esb_Update_Tp_LogBGInput/NclseaNcl_Esb_Update_Tp_Log/record_id"(string) to "mailContent"(string) -->
          <xsl:if test="$smo/body/in:executeNclseaNcl_Esb_Update_Tp_LogBG/in:executeNclseaNcl_Esb_Update_Tp_LogBGInput/NclseaNcl_Esb_Update_Tp_Log/record_id">
            <xsl:element name="mailContent">
              <!-- variables for custom code -->
              <xsl:variable name="record_id" select="$smo/body/in:executeNclseaNcl_Esb_Update_Tp_LogBG/in:executeNclseaNcl_Esb_Update_Tp_LogBGInput/NclseaNcl_Esb_Update_Tp_Log/record_id"/>
              <xsl:variable name="response_msg" select="$smo/body/in:executeNclseaNcl_Esb_Update_Tp_LogBG/in:executeNclseaNcl_Esb_Update_Tp_LogBGInput/NclseaNcl_Esb_Update_Tp_Log/response_msg"/>
