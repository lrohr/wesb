...
<!-- @generated mapFile="xslt/Request_To_INSERT_map.map" md5sum="261755734c4e6774a21ba09ebd965c60" version="7.6.100" -->
<!--
*****************************************************************************
*   This file has been generated by the IBM XML Mapping Editor.
*
*   Mapping file:		Request_To_INSERT_map.map
*   Map declaration(s):	Request_To_INSERT_map
...
*   Output file(s):		smo://smo/name%3Dwsdl-primary/message%3D%257Bhttp%253A%252F%252FTP_Logger%252FJDBCOutboundInterface%257DexecuteNclseaNcl_Esb_Insert_Tp_LogBGRequestMsg/xpath%3D%252F/smo.xsd
*
...
<xsl:stylesheet
    ...
    xmlns:map="http://TP_Logger/xslt/Request_To_INSERT_map"
  ...
  <xsl:template match="/">
    <xsl:choose>
      <xsl:when test="msl:datamap">
        <msl:datamap>
          <xsl:element name="dataObject">
            ...
            <xsl:call-template name="map:Request_To_INSERT_map2">
      ...
      <xsl:otherwise>
        <xsl:apply-templates select="io2:smo" mode="map:Request_To_INSERT_map"/>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>

  <!-- This rule represents an element mapping: "io2:smo" to "io2:smo".  -->
  <xsl:template match="io2:smo"  mode="map:Request_To_INSERT_map">
    <io2:smo>
      <body>
        <xsl:attribute name="xsi:type">
        ...
        <out:executeNclseaNcl_Esb_Insert_Tp_LogBG>
          <out:executeNclseaNcl_Esb_Insert_Tp_LogBGInput>
            <NclseaNcl_Esb_Insert_Tp_Log>
              ...
              <!-- a simple data mapping: "body/in:TP_InsertUpdate/SOURCE_CD"(string) to "source"(string) -->
              <xsl:if test="body/in:TP_InsertUpdate/SOURCE_CD">
                <xsl:choose>
                  <xsl:when test="normalize-space(body/in:TP_InsertUpdate/SOURCE_CD)">
              ...
              <!-- a simple data mapping: "body/in:TP_InsertUpdate/REQUEST_TS"(Date_Format) to "request_ts"(string) -->
              <xsl:if test="body/in:TP_InsertUpdate/REQUEST_TS">
                <xsl:choose>
                  <xsl:when test="normalize-space(body/in:TP_InsertUpdate/REQUEST_TS)">
              ...
              <!-- a simple data mapping: "body/in:TP_InsertUpdate/REQUEST_TYPE_CD"(string) to "request_type"(string) -->
              <xsl:if test="body/in:TP_InsertUpdate/REQUEST_TYPE_CD">
                <xsl:choose>
                  <xsl:when test="normalize-space(body/in:TP_InsertUpdate/REQUEST_TYPE_CD)">
              ...
              <!-- a simple data mapping: "body/in:TP_InsertUpdate/XML"(string) to "request_msg"(string) -->
  ...
  <xsl:template name="map:Request_To_INSERT_map2">
    <xsl:param name="smo"/>
    <body>
      <xsl:attribute name="xsi:type">
        <xsl:value-of select="'out3:executeNclseaNcl_Esb_Insert_Tp_LogBGRequestMsg'"/>
      ...
      <out:executeNclseaNcl_Esb_Insert_Tp_LogBG>
        <out:executeNclseaNcl_Esb_Insert_Tp_LogBGInput>
          <NclseaNcl_Esb_Insert_Tp_Log>
            ...
            <!-- a simple data mapping: "$smo/body/in:TP_InsertUpdate/SOURCE_CD"(string) to "source"(string) -->
            <xsl:if test="$smo/body/in:TP_InsertUpdate/SOURCE_CD">
              <xsl:choose>
                <xsl:when test="normalize-space($smo/body/in:TP_InsertUpdate/SOURCE_CD)">
                  <xsl:element name="source">
            ...
            <!-- a simple data mapping: "$smo/body/in:TP_InsertUpdate/REQUEST_TS"(Date_Format) to "request_ts"(string) -->
            <xsl:if test="$smo/body/in:TP_InsertUpdate/REQUEST_TS">
              <xsl:choose>
                <xsl:when test="normalize-space($smo/body/in:TP_InsertUpdate/REQUEST_TS)">
                  <xsl:element name="request_ts">
            ...
            <!-- a simple data mapping: "$smo/body/in:TP_InsertUpdate/REQUEST_TYPE_CD"(string) to "request_type"(string) -->
            <xsl:if test="$smo/body/in:TP_InsertUpdate/REQUEST_TYPE_CD">
              <xsl:choose>
                <xsl:when test="normalize-space($smo/body/in:TP_InsertUpdate/REQUEST_TYPE_CD)">
                  <xsl:element name="request_type">
            ...
            <!-- a simple data mapping: "$smo/body/in:TP_InsertUpdate/XML"(string) to "request_msg"(string) -->
