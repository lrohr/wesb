...
/**
 * @generated
 *  Flow: Agent_Create_Update Interface: NCL_CruiseCreateAgent_Interface Operation: Perform_NCL_CruiseCreateAgent Type: request Custom Mediation: removeEmptyWarnings
 */
public class Custom1257335594429 extends ESBMediationPrimitive {
	...
	public void doMediate(InputTerminal inputTerminal, ServiceMessageObject smo)
		...
		commonj.sdo.DataObject __result__3 = __smo.getDataObject("body")
				.getDataObject("Perform_NCL_CruiseCreateAgentResponse")
				.getDataObject("NCL_CruiseCreateAgentRS");
		...
		//  </executableElements>
		//  <executableElements xsi:type="com.ibm.wbit.activity:Expression" value="smo.body.Perform_NCL_CruiseCreateAgentResponse.NCL_CruiseCreateAgentRS" field="true">
		//    <dataOutputs target="//@executableElements.3/@parameters.0"/>
		//    <type xsi:type="com.ibm.wbit.activity:XSDElementType" name="NCL_CruiseCreateAgentRS;/NCL_CruiseCreateAgentRS" namespace="http://nclapi/schemas"/>
		//  </executableElements>
