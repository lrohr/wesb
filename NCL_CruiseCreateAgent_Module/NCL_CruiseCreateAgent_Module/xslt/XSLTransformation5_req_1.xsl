...
<!-- @generated mapFile="xslt/XSLTransformation5_req_1.map" md5sum="1804c2050a4443868a3b59675517d3f0" version="7.6.100" -->
<!--
*****************************************************************************
...
*   Output file(s):		smo://smo/name%3Dwsdl-primary/correlationContext%3D%257Bhttp%253A%252F%252FAgent_Create_Update%257Dapp_context/message%3D%257Bhttp%253A%252F%252FNCL_WESB_Shared_Library%252FEncrypt_Decrypt_Interface%257DprocessEncryptDecryptRequest/xpath%3D%252F/smo.xsd
*
...
<xsl:stylesheet
    ...
    xmlns:map="http://NCL_CruiseCreateAgent_Module/xslt/XSLTransformation5_req_1"
      ...
      <xsl:element name="body">
        ...
        <xsl:element name="out2:processEncryptDecryptRequest">
          <xsl:element name="Encrypt_Decrypt">
            ...
            <!-- a simple data mapping: "context/correlation/io6:NCL_CruiseCreateAgentRQ/io6:UserLogin/@Password"(StringLength1to64) to "DecryptString"(string) -->
    ...
    <xsl:element name="body">
      ...
      <xsl:element name="out2:processEncryptDecryptRequest">
        <xsl:element name="Encrypt_Decrypt">
          ...
          <!-- a simple data mapping: "$smo/context/correlation/io6:NCL_CruiseCreateAgentRQ/io6:UserLogin/@Password"(StringLength1to64) to "DecryptString"(string) -->
