...
*
*   Mapping file:		XSLT_buildDbException_req_1.map
*   Map declaration(s):	XSLT_buildDbException_req_1
...
<xsl:stylesheet
     ...
     xmlns:map="http://NCL_CruiseCreateAgent_Module/xslt/XSLT_buildDbException_req_1"
