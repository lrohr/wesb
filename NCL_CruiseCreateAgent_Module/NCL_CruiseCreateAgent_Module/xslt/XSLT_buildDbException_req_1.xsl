...
<!-- @generated mapFile="xslt/XSLT_buildDbException_req_1.map" md5sum="853710c20880564e68ee8af5e704b5c1" version="7.6.100" -->
<!--
*****************************************************************************
...
*   XSLT import(s):   	XSLT_buildDbException_req_1_custom.xsl
*
...
<xsl:stylesheet
  ...
  <!-- imports  -->
  <xsl:import href="XSLT_buildDbException_req_1_custom.xsl"/>
  ...
  <xsl:template match="/">
    <xsl:choose>
      <xsl:when test="msl:datamap">
        <msl:datamap>
          <xsl:element name="dataObject">
            ...
            <xsl:call-template name="map:XSLT_buildDbException_req_12">
      ...
      <xsl:otherwise>
        <xsl:apply-templates select="io3:smo" mode="map:XSLT_buildDbException_req_1"/>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>

  <!-- This rule represents an element mapping: "io3:smo" to "io3:smo".  -->
  <xsl:template match="io3:smo"  mode="map:XSLT_buildDbException_req_1">
    <io3:smo>
      <context>
        <correlation>
          <xsl:attribute name="xsi:type">
            ...
            <xsl:element name="io6:Warnings">
              <xsl:element name="io6:Warning">
                ...
                <xsl:attribute name="ShortText">
                  <xsl:value-of select="'Database exception'"/>
                </xsl:attribute>
              </xsl:element>
            </xsl:element>
          </xsl:element>
  ...
  <xsl:template name="map:XSLT_buildDbException_req_12">
    <xsl:param name="smo"/>
    <context>
      <correlation>
        <xsl:attribute name="xsi:type">
