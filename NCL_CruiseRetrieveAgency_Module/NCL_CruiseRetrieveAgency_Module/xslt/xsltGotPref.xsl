...
<!-- @generated mapFile="xslt/xsltGotPref.map" md5sum="246b501f88cd639323a1e42fb3c47a92" version="7.6.100" -->
<!--
*****************************************************************************
*   This file has been generated by the IBM XML Mapping Editor.
*
*   Mapping file:		xsltGotPref.map
*   Map declaration(s):	xsltGotPref
...
<xsl:stylesheet
    ...
    xmlns:map="http://NCL_CruiseRetrieveAgency_Module/xslt/xsltGotPref"
  ...
  <xsl:template match="/">
    <xsl:choose>
      <xsl:when test="msl:datamap">
        <msl:datamap>
          <xsl:element name="dataObject">
            ...
            <xsl:call-template name="map:xsltGotPref2">
      ...
      <xsl:otherwise>
        <xsl:apply-templates select="io2:smo" mode="map:xsltGotPref"/>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>

  <!-- This rule represents an element mapping: "io2:smo" to "io2:smo".  -->
  <xsl:template match="io2:smo"  mode="map:xsltGotPref">
    <io2:smo>
      <context>
        <correlation>
          <xsl:attribute name="xsi:type">
          ...
          <xsl:element name="pref">
            <xsl:element name="Get_AgencyContactPrefInfo">
              ...
              <xsl:apply-templates select="body/in16:executeNclseaNcl_Wesb_Ar_Get_Agc_Cont_PrfBGResponse/in16:executeNclseaNcl_Wesb_Ar_Get_Agc_Cont_PrfBGOutput/NclseaNcl_Wesb_Ar_Get_Agc_Cont_Prf/p_cursor" mode="localP_cursorToP_CURSOR_634610276"/>
            </xsl:element>
          </xsl:element>
        </correlation>
      </context>
        ...
        <xsl:element name="out2:Perform_NCL_CruiseRetrieveAgencyResponse">
          <xsl:element name="io5:NCL_CruiseRetrieveAgencyRS">
            ...
            <xsl:element name="io5:AgencyInfo">
              <!-- a simple data mapping: "context/correlation/info/Get_Agency_Info/P_CURSOR[1]/TAXPAYER_NUMBER"(string) to "IdentificationNumber"(StringLength0to32) -->
              <xsl:if test="context/correlation/info/Get_Agency_Info/P_CURSOR[1]/TAXPAYER_NUMBER">
                <xsl:attribute name="IdentificationNumber">
                  <xsl:value-of select="context/correlation/info/Get_Agency_Info/P_CURSOR[1]/TAXPAYER_NUMBER"/>
                </xsl:attribute>
              </xsl:if>
  ...
  <xsl:template name="map:xsltGotPref2">
    <xsl:param name="smo"/>
    <context>
      <correlation>
        <xsl:attribute name="xsi:type">
        ...
        <xsl:element name="pref">
          <xsl:element name="Get_AgencyContactPrefInfo">
            <!-- a for-each transform: "p_cursor"(NclseaNcl_Wesb_Ar_Get_Agc_Cont_PrfP_Cursor) to "P_CURSOR"(<Anonymous>) -->
            <xsl:apply-templates select="$smo/body/in16:executeNclseaNcl_Wesb_Ar_Get_Agc_Cont_PrfBGResponse/in16:executeNclseaNcl_Wesb_Ar_Get_Agc_Cont_PrfBGOutput/NclseaNcl_Wesb_Ar_Get_Agc_Cont_Prf/p_cursor" mode="localP_cursorToP_CURSOR_634610276"/>
          </xsl:element>
        </xsl:element>
      </correlation>
    </context>
    <xsl:element name="body">
      ...
      <xsl:element name="out2:Perform_NCL_CruiseRetrieveAgencyResponse">
        <xsl:element name="io5:NCL_CruiseRetrieveAgencyRS">
          ...
          <xsl:element name="io5:AgencyInfo">
            <!-- a simple data mapping: "$smo/context/correlation/info/Get_Agency_Info/P_CURSOR[1]/TAXPAYER_NUMBER"(string) to "IdentificationNumber"(StringLength0to32) -->
            <xsl:if test="$smo/context/correlation/info/Get_Agency_Info/P_CURSOR[1]/TAXPAYER_NUMBER">
              <xsl:attribute name="IdentificationNumber">
                <xsl:value-of select="$smo/context/correlation/info/Get_Agency_Info/P_CURSOR[1]/TAXPAYER_NUMBER"/>
              </xsl:attribute>
            </xsl:if>
            <xsl:element name="io5:RequestorID">
  ...
  <xsl:template match="p_cursor"  mode="localP_cursorToP_CURSOR_634610276">
    <P_CURSOR>
