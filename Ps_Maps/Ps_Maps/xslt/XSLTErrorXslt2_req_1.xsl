...
<!-- @generated mapFile="xslt/XSLTErrorXslt2_req_1.map" md5sum="f224d56d3a2591ed3921030d78302d83" version="7.6.100" -->
<!--
*****************************************************************************
*   This file has been generated by the IBM XML Mapping Editor.
*
*   Mapping file:		XSLTErrorXslt2_req_1.map
*   Map declaration(s):	XSLTErrorXslt2_req_1
...
<xsl:stylesheet
    ...
    xmlns:map="http://Ps_Maps/xslt/XSLTErrorXslt2_req_1"
  ...
  <xsl:template match="/">
    <xsl:choose>
      <xsl:when test="msl:datamap">
        <msl:datamap>
          <xsl:element name="dataObject">
            ...
            <xsl:call-template name="map:XSLTErrorXslt2_req_12">
      ...
      <xsl:otherwise>
        <xsl:apply-templates select="io3:smo" mode="map:XSLTErrorXslt2_req_1"/>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>

  <!-- This rule represents an element mapping: "io3:smo" to "io3:smo".  -->
  <xsl:template match="io3:smo"  mode="map:XSLTErrorXslt2_req_1">
    <io3:smo>
      <body>
        <xsl:attribute name="xsi:type">
  ...
  <xsl:template name="map:XSLTErrorXslt2_req_12">
    <xsl:param name="smo"/>
    <body>
      <xsl:attribute name="xsi:type">
        <xsl:value-of select="'out:sendSimpleAlertEmailRequestMsg'"/>
