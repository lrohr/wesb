...
<!-- @generated mapFile="xslt/XSLTransformation6_req_1.map" md5sum="11b48b1c48f578ae24f87397d6a60be2" version="7.6.100" -->
<!--
*****************************************************************************
...
<xsl:stylesheet
    ...
    xmlns:map="http://Ps_Maps/xslt/XSLTransformation6_req_1"
        ...
        <xsl:element name="out2:sendSimpleAlertEmail">
          <xsl:element name="out2:sendSimpleAlertEmailInput">
            ...
            <xsl:element name="Subject">
              <xsl:text>maps Failure</xsl:text>
            </xsl:element>
