...
<!-- @generated mapFile="xslt/Seaware_Down_req_1.map" md5sum="4b87bc178237840758d82060be4f42be" version="7.6.100" -->
<!--
*****************************************************************************
...
*   XSLT import(s):   	Seaware_Down_Success.xsl
*
...
<xsl:stylesheet
    ...
    xmlns:map="http://NCL_CruiseRetrieveClient_Module/xslt/Seaware_Down_req_1"
    xmlns:msl="http://www.ibm.com/xmlmap"
    exclude-result-prefixes="in in2 str set math fn regexp dyn dp exsl date map xalan msl"
    version="1.0">

  <!-- imports  -->
  <xsl:import href="Seaware_Down_Success.xsl"/>
  ...
  <xsl:template match="/">
    <xsl:choose>
      <xsl:when test="msl:datamap">
        <msl:datamap>
          <xsl:element name="dataObject">
            ...
            <xsl:call-template name="map:Seaware_Down_req_12">
      ...
      <xsl:otherwise>
        <xsl:apply-templates select="io2:smo" mode="map:Seaware_Down_req_1"/>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>

  <!-- This rule represents an element mapping: "io2:smo" to "io2:smo".  -->
  <xsl:template match="io2:smo"  mode="map:Seaware_Down_req_1">
    <io2:smo>
      <context>
        <correlation>
          <xsl:attribute name="xsi:type">
            ...
            <xsl:element name="io6:Warnings">
              <xsl:element name="io6:Warning">
                ...
                <xsl:attribute name="ShortText">
                  <xsl:value-of select="'Seaware is not available'"/>
                </xsl:attribute>
              </xsl:element>
            </xsl:element>
          </xsl:element>
  ...
  <xsl:template name="map:Seaware_Down_req_12">
    <xsl:param name="smo"/>
    <context>
      <correlation>
        <xsl:attribute name="xsi:type">
