...
<!-- @generated mapFile="xslt/XSLT_err_5_req_1.map" md5sum="0e5606a41c37c444c5849790d22abacb" version="7.6.100" -->
<!--
*****************************************************************************
...
*   XSLT import(s):   	XSLT_err_5_req_1_custom.xsl
*
...
<xsl:stylesheet
    ...
    xmlns:map="http://NCL_CruiseRetrieveClient_Module/xslt/XSLT_err_5_req_1"
  ...
  <!-- imports  -->
  <xsl:import href="XSLT_err_5_req_1_custom.xsl"/>
  ...
  <xsl:template match="/">
    <xsl:choose>
      <xsl:when test="msl:datamap">
        <msl:datamap>
          <xsl:element name="dataObject">
            ...
            <xsl:call-template name="map:XSLT_err_5_req_12">
      ...
      <xsl:otherwise>
        <xsl:apply-templates select="io2:smo" mode="map:XSLT_err_5_req_1"/>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>

  <!-- This rule represents an element mapping: "io2:smo" to "io2:smo".  -->
  <xsl:template match="io2:smo"  mode="map:XSLT_err_5_req_1">
    <io2:smo>
      <context>
            ...
            <xsl:element name="io6:Warnings">
              <xsl:element name="io6:Warning">
                ...
                <xsl:attribute name="ShortText">
                  <xsl:value-of select="'Unexpected Err 5'"/>
                </xsl:attribute>
              </xsl:element>
            </xsl:element>
          </xsl:element>
  ...
  <xsl:template name="map:XSLT_err_5_req_12">
    <xsl:param name="smo"/>
    <context>
