...
<!-- @generated mapFile="xslt/XSLTransformation1_req_9.map" md5sum="15a99e98123b93afa8f3791ad924e851" version="7.5.100" -->
<!--
*****************************************************************************
...
*   XSLT import(s):   	XSLTransformation1_req_9_custom.xsl
*
...
<xsl:stylesheet
    ...
    xmlns:map="http://NCL_CruiseRetrieveClient_Module/xslt/XSLTransformation1_req_9"
    xmlns:msl="http://www.ibm.com/xmlmap"
    exclude-result-prefixes="str set math fn regexp dyn dp exsl date map xalan msl"
    version="1.0">

  <!-- imports  -->
  <xsl:import href="XSLTransformation1_req_9_custom.xsl"/>
  ...
  <xsl:template match="/">
    <xsl:choose>
      <xsl:when test="msl:datamap">
        <msl:datamap>
          <xsl:element name="dataObject">
            ...
            <xsl:call-template name="map:XSLTransformation1_req_92">
      ...
      <xsl:otherwise>
        <xsl:apply-templates select="io2:smo" mode="map:XSLTransformation1_req_9"/>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>

  <!-- This rule represents an element mapping: "io2:smo" to "io2:smo".  -->
  <xsl:template match="io2:smo"  mode="map:XSLTransformation1_req_9">
    <io2:smo>
      <context>
            ...
            <xsl:element name="io7:Warnings">
              <xsl:element name="io7:Warning">
                ...
                <xsl:attribute name="ShortText">
                  <xsl:value-of select="'Unexpected Err 12'"/>
                </xsl:attribute>
              </xsl:element>
            </xsl:element>
          </xsl:element>
  ...
  <xsl:template name="map:XSLTransformation1_req_92">
    <xsl:param name="smo"/>
    <context>
