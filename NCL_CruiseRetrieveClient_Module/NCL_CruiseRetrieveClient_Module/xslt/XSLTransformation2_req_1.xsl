...
<!-- @generated mapFile="xslt/XSLTransformation2_req_1.map" md5sum="1cf7b28231e77b526707a328494541a2" version="7.6.100" -->
<!--
*****************************************************************************
...
*   XSLT import(s):   	XSLTransformation2_success.xsl
*
...
<xsl:stylesheet
  ...
  <!-- imports  -->
  <xsl:import href="XSLTransformation2_success.xsl"/>
            ...
            <xsl:element name="io6:Warnings">
              <xsl:element name="io6:Warning">
                ...
                <xsl:attribute name="ShortText">
                  <xsl:value-of select="'Invalid Client Information'"/>
                </xsl:attribute>
