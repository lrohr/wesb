...
<xsl:stylesheet
  ...
  <!-- The rule represents a custom mapping: "previous_cruise_line" to "io5:PreviousCruiseLines". -->
  <xsl:template name="Previous_cruise_lineToPreviousCruiseLines">
    <xsl:param name="previous_cruise_line"/>
    <xsl:param name="p_prev_crus_cur"/>
    <!-- ADD CUSTOM CODE HERE. -->
    <xsl:for-each select="document('$previous_cruise_line">
