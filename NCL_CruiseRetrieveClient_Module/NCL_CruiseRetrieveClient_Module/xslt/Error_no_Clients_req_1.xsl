...
<!-- @generated mapFile="xslt/Error_no_Clients_req_1.map" md5sum="e8f8568bad10e04804db86f9290e9eb9" version="7.6.100" -->
<!--
*****************************************************************************
...
*   XSLT import(s):   	Error_no_Clients_req_1_custom.xsl
*
...
<xsl:stylesheet
    ...
    xmlns:map="http://NCL_CruiseRetrieveClient_Module/xslt/Error_no_Clients_req_1"
  ...
  <!-- imports  -->
  <xsl:import href="Error_no_Clients_req_1_custom.xsl"/>
  ...
  <xsl:template match="/">
    <xsl:choose>
      <xsl:when test="msl:datamap">
        <msl:datamap>
          <xsl:element name="dataObject">
            ...
            <xsl:call-template name="map:Error_no_Clients_req_12">
      ...
      <xsl:otherwise>
        <xsl:apply-templates select="io2:smo" mode="map:Error_no_Clients_req_1"/>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>

  <!-- This rule represents an element mapping: "io2:smo" to "io2:smo".  -->
  <xsl:template match="io2:smo"  mode="map:Error_no_Clients_req_1">
    <io2:smo>
      <context>
        <correlation>
          <xsl:attribute name="xsi:type">
  ...
  <xsl:template name="map:Error_no_Clients_req_12">
    <xsl:param name="smo"/>
    <context>
      <correlation>
        <xsl:attribute name="xsi:type">
