...
<!-- @generated mapFile="xslt/XSLT_err_13_req_1.map" md5sum="ce0ed09dff27195aae4e46c2504d773f" version="7.6.100" -->
<!--
*****************************************************************************
...
*   XSLT import(s):   	XSLT_err_13_req_1_custom.xsl
*
...
<xsl:stylesheet
    ...
    xmlns:map="http://NCL_CruiseRetrieveClient_Module/xslt/XSLT_err_13_req_1"
  ...
  <!-- imports  -->
  <xsl:import href="XSLT_err_13_req_1_custom.xsl"/>
  ...
  <xsl:template match="/">
    <xsl:choose>
      <xsl:when test="msl:datamap">
        <msl:datamap>
          <xsl:element name="dataObject">
            ...
            <xsl:call-template name="map:XSLT_err_13_req_12">
      ...
      <xsl:otherwise>
        <xsl:apply-templates select="io2:smo" mode="map:XSLT_err_13_req_1"/>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>

  <!-- This rule represents an element mapping: "io2:smo" to "io2:smo".  -->
  <xsl:template match="io2:smo"  mode="map:XSLT_err_13_req_1">
    <io2:smo>
      <context>
  ...
  <xsl:template name="map:XSLT_err_13_req_12">
    <xsl:param name="smo"/>
    <context>
