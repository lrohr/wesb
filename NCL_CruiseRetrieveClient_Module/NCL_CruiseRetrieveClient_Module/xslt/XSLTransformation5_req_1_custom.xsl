...
<xsl:stylesheet
  ...
  <!-- The rule represents a custom mapping: "desired_destination" to "io5:DesiredDestination". -->
  <xsl:template name="Desired_destinationToDesiredDestination">
    <xsl:param name="desired_destination"/>
    <!-- ADD CUSTOM CODE HERE. -->
  <xsl:for-each select="$desired_destination">
