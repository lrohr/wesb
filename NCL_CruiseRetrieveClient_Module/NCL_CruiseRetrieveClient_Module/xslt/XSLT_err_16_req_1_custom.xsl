...
<xsl:stylesheet
     ...
     xmlns:io3="http://NCL_WESB_Shared_Library/NCL_CruiseRetrieveClient_Interface"
     ...
     xmlns:io8="wsdl.http://NCL_WESB_Shared_Library/NCL_CruiseRetrieveClient_Interface"
  ...
  <!-- The rule represents a custom mapping: "TransactionIdentifier" to "io6:Success". -->
