...
<!-- @generated mapFile="xslt/XSLTransformation5_req_2.map" md5sum="1ca1698692ba8025fcb9921393a9e98f" version="7.6.100" -->
<!--
*****************************************************************************
...
<xsl:stylesheet
    ...
    xmlns:map="http://NCL_CruiseLinkReservation_Module/xslt/XSLTransformation5_req_2"
    xmlns:msl="http://www.ibm.com/xmlmap"
    exclude-result-prefixes="in2 in in3 str set math fn regexp dyn dp exsl date map xalan msl"
    version="1.0">
  ...
  <xsl:template match="/">
    <xsl:choose>
      <xsl:when test="msl:datamap">
        <msl:datamap>
          <xsl:element name="dataObject">
            ...
            <xsl:call-template name="map:XSLTransformation5_req_22">
      ...
      <xsl:otherwise>
        <xsl:apply-templates select="io2:smo" mode="map:XSLTransformation5_req_2"/>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>

  <!-- This rule represents an element mapping: "io2:smo" to "io2:smo".  -->
  <xsl:template match="io2:smo"  mode="map:XSLTransformation5_req_2">
    <io2:smo>
      <context>
        <correlation>
          <xsl:attribute name="xsi:type">
  ...
  <xsl:template name="map:XSLTransformation5_req_22">
    <xsl:param name="smo"/>
    <context>
      <correlation>
        <xsl:attribute name="xsi:type">
