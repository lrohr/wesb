...
<!-- @generated mapFile="xslt/XSLTransformation3_req_1.map" md5sum="7a17ab098610de9e72635059b63bff13" version="7.6.100" -->
<!--
*****************************************************************************
...
<xsl:stylesheet
    ...
    xmlns:map="http://NCL_CruiseLinkReservation_Module/xslt/XSLTransformation3_req_1"
            ...
            <xsl:element name="io5:Warnings">
              <xsl:element name="io5:Warning">
                ...
                <xsl:attribute name="ShortText">
                  <xsl:value-of select="'Invalid Input in Request'"/>
                </xsl:attribute>
              </xsl:element>
            </xsl:element>
          </xsl:element>
