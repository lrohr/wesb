...
/**
 * @generated
 *  Flow: NCL_CruiseUserAuthentication_Module Interface: NCL_CruiseUserAuthentication_Interface Operation: Perform_NCL_CruiseUserAuthentication Type: request Custom Mediation: removeEmptyWarnings
 */
public class Custom1257184588457 extends ESBMediationPrimitive {
	...
	public void doMediate(InputTerminal inputTerminal, ServiceMessageObject smo)
		...
		commonj.sdo.DataObject __result__3 = __smo.getDataObject("body")
				.getDataObject("Perform_NCL_CruiseUserAuthenticationResponse")
				.getDataObject("NCL_CruiseUserAuthenticationRS");
		...
		//  </executableElements>
		//  <executableElements xsi:type="com.ibm.wbit.activity:Expression" value="smo.body.Perform_NCL_CruiseUserAuthenticationResponse.NCL_CruiseUserAuthenticationRS" field="true">
		//    <dataOutputs target="//@executableElements.3/@parameters.0"/>
		//    <type xsi:type="com.ibm.wbit.activity:XSDElementType" name="NCL_CruiseUserAuthenticationRS;/NCL_CruiseUserAuthenticationRS" namespace="http://nclapi/schemas"/>
		//  </executableElements>
