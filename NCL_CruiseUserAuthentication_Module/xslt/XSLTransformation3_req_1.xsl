...
<!-- @generated mapFile="xslt/XSLTransformation3_req_1.map" md5sum="b0a89adeee96c068a2ca25d42290b3f8" version="7.6.100" -->
<!--
*****************************************************************************
...
<xsl:stylesheet
    ...
    xmlns:map="http://NCL_CruiseUserAuthentication_Module/xslt/XSLTransformation3_req_1"
      ...
      <xsl:element name="body">
        ...
        <xsl:element name="out2:Send_Email1">
          ...
          <xsl:element name="Subject">
            <xsl:text>log error (Insert) from uatreq</xsl:text>
          </xsl:element>
