...
<!-- @generated mapFile="xslt/XSLTransformation2_req_4.map" md5sum="ab3d14aa4326e2b2380cac8e0f9a374b" version="7.5.100" -->
<!--
*****************************************************************************
*   This file has been generated by the IBM XML Mapping Editor.
*
*   Mapping file:		XSLTransformation2_req_4.map
*   Map declaration(s):	XSLTransformation2_req_4
...
<xsl:stylesheet
    ...
    xmlns:map="http://NCL_CruiseUserAuthentication_Module/xslt/XSLTransformation2_req_4"
  ...
  <xsl:template match="/">
    <xsl:choose>
      <xsl:when test="msl:datamap">
        <msl:datamap>
          <xsl:element name="dataObject">
            ...
            <xsl:call-template name="map:XSLTransformation2_req_42">
      ...
      <xsl:otherwise>
        <xsl:apply-templates select="io2:smo" mode="map:XSLTransformation2_req_4"/>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>

  <!-- This rule represents an element mapping: "io2:smo" to "io2:smo".  -->
  <xsl:template match="io2:smo"  mode="map:XSLTransformation2_req_4">
    <io2:smo>
      <context>
  ...
  <xsl:template name="map:XSLTransformation2_req_42">
    <xsl:param name="smo"/>
    <context>
