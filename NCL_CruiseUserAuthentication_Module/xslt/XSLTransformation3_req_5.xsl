...
<!-- @generated mapFile="xslt/XSLTransformation3_req_5.map" md5sum="d2c5ed9f6e5a5e6a299dddfedd26bd59" version="7.5.100" -->
<!--
*****************************************************************************
...
*   XSLT import(s):   	XSLTransformation3_req_5_custom.xsl
*
...
<xsl:stylesheet
    ...
    xmlns:map="http://NCL_CruiseUserAuthentication_Module/xslt/XSLTransformation3_req_5"
    xmlns:msl="http://www.ibm.com/xmlmap"
    exclude-result-prefixes="in in2 str set math fn regexp dyn dp exsl date map xalan msl"
    version="1.0">

  <!-- imports  -->
  <xsl:import href="XSLTransformation3_req_5_custom.xsl"/>
      ...
      <xsl:when test="msl:datamap">
        <msl:datamap>
          <xsl:element name="dataObject">
            ...
            <xsl:call-template name="map:XSLTransformation3_req_52">
  ...
  <xsl:template name="map:XSLTransformation3_req_52">
    <xsl:param name="smo"/>
    <context>
