...
<!-- @generated mapFile="xslt/XSLTransformation2_req_1.map" md5sum="e22146dd5603ac02569d806d5c316437" version="7.6.100" -->
<!--
*****************************************************************************
...
<xsl:stylesheet
    ...
    xmlns:map="http://NCL_CruiseUserAuthentication_Module/xslt/XSLTransformation2_req_1"
      ...
      <body>
        ...
        <out2:Send_Email1>
          ...
          <xsl:element name="Subject">
            <xsl:text>Error on Encrypt/Decrypt</xsl:text>
          </xsl:element>
          <!-- a simple mapping with no associated source:  to "Content"(string) -->
          <xsl:element name="Content">
            <xsl:text>Please verify encrypt/Decrypt IP address connection</xsl:text>
          </xsl:element>
