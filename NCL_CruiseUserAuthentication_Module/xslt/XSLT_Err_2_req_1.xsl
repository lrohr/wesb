...
<!-- @generated mapFile="xslt/XSLT_Err_2_req_1.map" md5sum="1fd72e709d7ddd71714755f42aa88a80" version="7.5.100" -->
<!--
*****************************************************************************
...
<xsl:stylesheet
    ...
    xmlns:map="http://NCL_CruiseUserAuthentication_Module/xslt/XSLT_Err_2_req_1"
            ...
            <xsl:element name="io5:Warnings">
              <xsl:element name="io5:Warning">
                ...
                <xsl:attribute name="ShortText">
                  <xsl:value-of select="'Unexpected Err 2'"/>
                </xsl:attribute>
              </xsl:element>
            </xsl:element>
          </xsl:element>
